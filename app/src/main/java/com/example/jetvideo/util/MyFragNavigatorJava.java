...
@Navigator.Name("myFragNavigatorJava")
public class MyFragNavigatorJava extends FragmentNavigator {
    private static final String TAG = "FixFragmentNavigator";
    private Context mContext;
    private FragmentManager mManager;
    private int mContainerId;

    public MyFragNavigatorJava(@NonNull Context context, @NonNull FragmentManager manager, int containerId) {
